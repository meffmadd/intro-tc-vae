...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--arch", type=str, choices=["conv", "res", "inception"], default="res", 
    ...
    parser.add_argument("-o", "--optimizer", type=str, choices=["adam", "adadelta", "adagrad", "RMSprop"])
    ...
    parser.add_argument("--dropout", type=float,
                        help="dropout probability of an element", default=0.0)
    ...
    parser.add_argument("--amp", action='store_true', help="enable automatic multi precision")
    ...
    train_soft_intro_vae(dataset=args.dataset, arch=args.arch, z_dim=args.z_dim, batch_size=args.batch_size, num_workers=2,
                         num_epochs=args.num_epochs, dropout=args.dropout, optimizer=args.optimizer,
                         ...
                         test_iter=1000, use_tensorboard=args.tensorboard, use_amp=args.amp)